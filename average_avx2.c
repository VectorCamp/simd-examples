...
main() {
    ...
    // temp2 = [b+f+a+e, a+e+b+f, d+h+c+g, d+h+c+g, b+f+a+e, a+e+b+f, d+h+c+g,
    // d+h+c+g]
    tmp2 = _mm256_add_ps(tmp2, _mm256_permute_ps(tmp2, 0xB1));   // 0xB1: 10110001 2 3 0 1
    // premutation = [d+h+c+g, d+h+c+g, b+f+a+e, a+e+b+f, d+h+c+g, d+h+c+g,
    // b+f+a+e, a+e+b+f] temp2 = [b+f+a+e+d+h+c+g, b+f+a+e+d+h+c+g,
    // b+f+a+e+d+h+c+g, b+f+a+e+d+h+c+g,b+f+a+e+d+h+c+g, b+f+a+e+d+h+c+g,
    // b+f+a+e+d+h+c+g, b+f+a+e+d+h+c+g]
